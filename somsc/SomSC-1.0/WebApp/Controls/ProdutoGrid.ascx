...
<p>
    <asp:ListView ID="ProdutosListView" runat="server" DataKeyNames="Id" DataSourceID="ProdutosLinqData"
        InsertItemPosition="LastItem" OnItemCommand="ProdutosListView_ItemCommand" OnItemInserting="ProdutosListView_ItemInserting"
        OnItemUpdating="ProdutosListView_ItemUpdating">
        <ItemTemplate>
            <tr style="">
                <td>
                    <asp:Label ID="CodigoLabel" runat="server" Text='<%# Eval("Codigo") %>' Width="50" />
                </td>
                <td>
            ...
            <tr>
                ...
                <td colspan="2">
                    <asp:Label ID="PrecoCustoLabel" runat="server" Text='<%# Eval("PrecoCusto", "{0:c}") %>'
                        Width="100" />
                </td>
                <td>
        ...
        <InsertItemTemplate>
            <tr style="">
                <td>
                    <asp:TextBox ID="CodigoTextBox" runat="server" Text='<%# Bind("Codigo") %>' Width="50" />
                    <asp:RequiredFieldValidator runat="server" SetFocusOnError="true" Text="*" ErrorMessage="Informe um código."
                        ValidationGroup="GroupA" ControlToValidate="CodigoTextBox" />
                </td>
                <td>
            ...
            <tr>
                ...
                <td colspan="2">
                    <asp:TextBox ID="PrecoCustoTextBox" runat="server" Text='<%# Bind("PrecoCusto") %>'
                        Width="100" />
                    <asp:CompareValidator runat="server" SetFocusOnError="true" Text="*" ErrorMessage="Informe o preço de custo."
                        ValidationGroup="GroupA" Type="Double" Operator="DataTypeCheck" ControlToValidate="PrecoCustoTextBox" />
                    <asp:RequiredFieldValidator runat="server" SetFocusOnError="true" Text="*" ErrorMessage="Informe o preço de custo."
                        ValidationGroup="GroupA" ControlToValidate="PrecoCustoTextBox" />
                </td>
                <td>
        ...
        <LayoutTemplate>
            <table id="itemPlaceholderContainer" runat="server" class="grid">
                <tr runat="server" style="">
                    <th runat="server">
                        <asp:LinkButton ID="CodigoButton" runat="server" CommandName="Sort" CommandArgument="Codigo"
                            Text="Código" />
                    </th>
                    <th runat="server">
                ...
                <tr>
                    ...
                    <th runat="server" colspan="2" align="right">
                        <asp:LinkButton ID="PrecoButton" runat="server" CommandName="Sort" CommandArgument="PrecoCusto"
                            Text="Preço Custo" />
                    </th>
                    <th runat="server">
                    </th>
            ...
            <tr>
                ...
                <td colspan="2">
                    ...
                    <asp:CompareValidator ID="CompareValidator1" runat="server" SetFocusOnError="true"
                        Text="*" ErrorMessage="Informe o preço de custo." ValidationGroup="GroupA" Type="Double"
                        Operator="DataTypeCheck" ControlToValidate="PrecoCustoTextBox" />
                    <asp:RequiredFieldValidator runat="server" SetFocusOnError="true" Text="*" ErrorMessage="Informe o preço de custo."
                        ValidationGroup="GroupA" ControlToValidate="PrecoCustoTextBox" />
                </td>
                <td>
...
<asp:LinqDataSource ID="ProdutosLinqData" runat="server" ContextTypeName="Com.Gt.SomSc.Domain.Entities.SomScDataContext"
    ...
    OrderBy="Codigo" OnLoad="ProdutosLinqData_Load">
</asp:LinqDataSource>
