...
<p>
    <asp:ListView ID="CriticosListView" runat="server" DataSourceID="CriticosObjectData">
        <ItemTemplate>
            <tr style="">
                <td>
...
<asp:ObjectDataSource ID="CriticosObjectData" runat="server" SelectMethod="GetCriticos"
    TypeName="Com.Gt.SomSc.Domain.Entities.SomScDataContext" OnObjectDisposing="CriticosObjectData_ObjectDisposing"
    SortParameterName="Sort">
    <SelectParameters>
        <asp:ControlParameter ControlID="CategoriaFilterComboBox" Name="IdCategoria" PropertyName="DataBindID"
            Type="Int32" />
        <asp:ControlParameter ControlID="FornecedorFilterComboBox" Name="IdFornecedor" PropertyName="DataBindID"
            Type="Int32" />
    </SelectParameters>
